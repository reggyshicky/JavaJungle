...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        //nextLine() gets skipped when placed after nextInt(), nextDouble(), nextLog() and next()
        //solution: place a throaway nextLine before the 'real' nextLine
        // nextInt() example
        ...
        System.out.print("\nEnter a greeting: ");
        scanner.nextLine(); //throwway nextLine to be wasted on empty space
        ...
        scanner.nextLine();
        String colorCombination = scanner.nextLine(); //throwway nextLine to be wasted on empty space
